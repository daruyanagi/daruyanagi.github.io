...
{{< x user="daruyanagi" id="2056915836770881987" >}}

winget でもインストールできるようになりました。

```
# winget（ZIP、毎バージョン）
winget install daruyanagi.XTimelineViewer

# Microsoft Store（MSIX、マイナーバージョンアップ以上のみ更新）
winget install 9P308HB5BLJ1 --source msstore
```

wingetpkg へのプルリクをレビューしてくださったボランティアの方、ありがとうございました。これで自動アップデートが容易になったと思います！　これベースで自動更新機能も付けられないかな？　あとで Claude に聞いてみる
